/*
 ...
 Source Schema         : ka-mall

 Target Server Type    : MySQL
 Target Server Version : 80027
 File Encoding         : 65001

 Date: 16/09/2022 23:12:20
*/
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '普通用户权限', NULL, NULL, '0', '0', 'sys:common:user', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (2, '普通管理员权限', NULL, NULL, '0', '0', 'sys:common:admin', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (3, '超级管理员权限', NULL, NULL, '0', '0', 'sys:super:admin', '#', NULL, NULL, NULL, NULL, 0, NULL);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '用户', 'user', '0', 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role` VALUES (2, '普通管理员', 'admin', '0', 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role` VALUES (3, '超级管理员', 'root', '0', 0, NULL, NULL, NULL, NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'Kamisora', 'NULL', '$2a$10$/glU6SRk4.jCzHJRIPS2zO5e0YnjPCkgOhabWXp2pvBljqmFMkwR.', '0', NULL, NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (2, 'kaka', 'NULL', '$2a$10$/glU6SRk4.jCzHJRIPS2zO5e0YnjPCkgOhabWXp2pvBljqmFMkwR.', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
...
CREATE TABLE `sys_user_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1570789813446529026 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户登录记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_user_login_log
-- ----------------------------
INSERT INTO `sys_user_login_log` VALUES (1570789813446529025, 1, '2022-09-16 23:00:50', '192.168.36.254', NULL, NULL, NULL);
